...
# Stepwise function to analyze relevant features based in logistic regression
...
step_lm_over <- stepAIC(glm_0, direction = "both", trace = F)
summary(step_lm_over)
```
